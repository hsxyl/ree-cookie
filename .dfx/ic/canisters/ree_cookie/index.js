...
import { idlFactory } from './ree_cookie.did.js';
export { idlFactory } from './ree_cookie.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_REE_COOKIE;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ree_cookie.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ree_cookie canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ree_cookie.did.js")._SERVICE>}
 */
export const ree_cookie = createActor(canisterId);
