...
async fn test_call() {
    ...
    let pool_balance = 10_000_u64;
    let user_address = "tb1q55gghpce6jgq8q78cfcnmkz8qq5ww3as8vn5ka";
    let user_script_buf =
        ScriptBuf::from_hex("0014a5108b8719d4900383c7c2713dd8470028e747b0").unwrap();
    let user_balance = 500000_u64;
    //
    let mut psbt = Psbt {
    ...
    add_input(
        &mut psbt,
        "6f33b179d979fe0978a43762eeb55a685fff56a03b3407f0b39fe5c773215384",
        1,
        user_balance,
    ...
    add_input(
        &mut psbt,
        "31430cddbdae89b78e8d7873de3dc2d65840c6ab498ccb8a4268b5b75de5a6bc",
        0,
        pool_balance,
    ...
    let user_change = user_balance - register_fee - estimated_fee.unwrap();
